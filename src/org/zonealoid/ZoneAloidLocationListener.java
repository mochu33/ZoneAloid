...
public class ZoneAloidLocationListener implements LocationListener {

	public static final int MIN_TIME = 30000; // 30seg
	public static final int MIN_DISTANCE = 20; // 20 meters
	protected Location currentBestLocation;

	@Override
	public void onLocationChanged(Location location) {
		Log.d("ZoneAloid", "Location changed");
